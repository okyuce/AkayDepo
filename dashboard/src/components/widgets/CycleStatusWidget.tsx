    ...
    return (
      <div className="card p-6 animate-fade-in">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-800">Aktif Dongu</h3>
            <p className="text-sm text-gray-500">Dongu bilgileri</p>
          </div>
        </div>
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 font-medium">Aktif dongu bulunamadi</p>
          <p className="text-sm text-gray-400 mt-1">Excel yuklenerek yeni dongu baslatilabilir</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="card p-6 animate-fade-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-800">Aktif Dongu</h3>
          <p className="text-sm text-gray-500">Dongu #{cycle.cycle_no}</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-4">
          <p className="text-xs text-cyan-600 font-medium uppercase tracking-wide mb-1">Calistirma Saati</p>
          <p className="text-lg font-bold text-gray-800">{cycle.run_time}</p>
        </div>
      </div>

      {lastImport && (
        <div className="border-t border-gray-100 pt-4">
          <p className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-3">Son Excel Yukleme</p>
